...
def generate_launch_description():
    ...
    declare_arg_world = DeclareLaunchArgument(
        'base_world', default_value='experiment_room.world',
    ...
    declare_arg_py = DeclareLaunchArgument('gzpose_y', default_value='-8.0',
    ...
    declare_arg_pY = DeclareLaunchArgument('gzpose_Y', default_value='1.6',
