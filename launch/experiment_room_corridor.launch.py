...
def generate_launch_description():
    ...
    declare_arg_world = DeclareLaunchArgument(
        'base_world', default_value='corridor.world',
    ...
    declare_arg_px = DeclareLaunchArgument('gzpose_x', default_value='7.75',
    ...
    declare_arg_pY = DeclareLaunchArgument('gzpose_Y', default_value='3.1',
